...
![Terminal output showing npm run reset](https://res.cloudinary.com/total-typescript/image/upload/v1784724469/ai-hero-images/vnwqiydtjqeik72mz6yl.png)
...
![Agent exploring the codebase during plan mode](https://res.cloudinary.com/total-typescript/image/upload/v1784724470/ai-hero-images/obq7zhdtilsfmhiojwt5.png)
...
![Terminal showing the /plan command output](https://res.cloudinary.com/total-typescript/image/upload/v1784724471/ai-hero-images/s91ltu5z2habcofjeeyt.png)
...
<Quiz>
  <QuizQuestion data={{
    ...
    choices: [
      { answer: "asset-rush", label: "It rushed to an asset again - the plan is the implementation" },
      { answer: "too-vague", label: "It is too vague to review, so you cannot judge the approach" },
      { answer: "no-exploring", label: "It skipped exploring the codebase, so the plan is guesswork" },
      { answer: "not-editable", label: "It cannot be changed, so you have to accept the plan as it is" }
    ],
    correct: "asset-rush",
  ...
  <QuizQuestion data={{
    ...
    type: "multiple-choice",
    choices: [
      { answer: "sycophancy", label: "Sycophancy - producing whatever you asked for" },
      { answer: "hallucination", label: "Hallucination - inventing facts with no source" },
      { answer: "non-determinism", label: "Non-determinism - behaving differently each run" },
      { answer: "degradation", label: "Degradation - losing focus as a session grows" }
    ],
    correct: "sycophancy",
  ...
  <QuizQuestion data={{
    ...
    type: "multiple-choice",
    choices: [
      { answer: "design-concept", label: "A design concept - shared understanding, not an artifact" },
      { answer: "spec", label: "A specification the implementation can be checked against" },
      { answer: "informal-plan", label: "A plan document, just held in an informal spoken form" },
      { answer: "nothing", label: "Nothing usable until one of you writes the decisions down" }
    ],
