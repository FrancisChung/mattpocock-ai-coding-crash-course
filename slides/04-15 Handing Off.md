...
![The /handoff skill file showing the skill definition](https://res.cloudinary.com/total-typescript/image/upload/v1784727431/ai-hero-images/dbqwmk3vzmn4zkyw4wb5.png)
...
![Agent requesting permission to write to the temporary directory](https://res.cloudinary.com/total-typescript/image/upload/v1784727432/ai-hero-images/prk8tezzgfbgbcsyxbza.png)

![VS Code showing the generated handoff document](https://res.cloudinary.com/total-typescript/image/upload/v1784727433/ai-hero-images/ssowi3pzda1bcvivq3xe.png)
...
![A fresh agent session reading in the handoff document](https://res.cloudinary.com/total-typescript/image/upload/v1784727434/ai-hero-images/q5xyjuestj3paiiecrh6.png)
...
<Quiz>
  <QuizQuestion data={{
    ...
    choices: [
      { answer: "handoff-file", label: "Write a handoff document, then reference it from Codex" },
      { answer: "compact", label: "Compact the session, then reopen that session in Codex" },
      { answer: "clear", label: "Clear, and let Codex explore the repository on its own" },
      { answer: "notes-in-repo", label: "Save a summary into the project as a notes.md file to read" }
    ],
  ...
  <QuizQuestion data={{
    ...
    type: "multiple-choice",
    choices: [
      { answer: "os-temp", label: "The OS temporary directory - it gets cleared in time" },
      { answer: "project", label: "The project root - it is committed alongside your work" },
      { answer: "memory", label: "The agent memory - it loads into every later session" },
      { answer: "home-dir", label: "A folder in your home directory - it is kept forever" }
    ],
    correct: "os-temp",
